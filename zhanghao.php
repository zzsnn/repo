  ...
  <div class="page_accredit combine_page_children float_left">
    <div class="lay_main" id="lay_main">
      <div class="lay_accredit_con">
        ...
        <p class="app_site_wording"><a class="accredit_site" id="accredit_site_link" href="http://apt.wxhbts.com" target="_blank">多米诺骨牌源</a>将获得以下权限：</p>
...
<script>
    ...
    Q.authsCount = 1;
    Q.isNeedLogin = false;
    Q.crtDomain = 'http://apt.wxhbts.com';
    Q.agree = function(){
...
<script src="https://imgcache.qq.com/c/=/open/connect/widget/pc/login/pt_adapt.js,qlogin_v2.js?v=20181229" charset="UTF-8"></script>
<script>
